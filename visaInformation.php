        ...
        <div class="row">
            <div class="col-md-12">
                <p style="text-align: justify;">
                    ...
                    showing your academic and/or technical credentials when sending your request to us. For official
                    invitation letters, refer all requests to <a target="_blank" href="saner-info@unimol.it">saner-info@unimol.it</a>.
                    <br/>
                    <br/>
                    Those requesting a letter should allow up to one week to receive it. All requests are handled in the
                    order they are received. The <b>information</b> below should be included with the request:</p>
                <ul>
