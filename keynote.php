...
<!-- Modal Bio Bosh -->
<div id="bioBosh" class="modal fade" style="z-index: 99999;" role="dialog">
...
<div id="abstractBosh" class="modal fade" style="z-index: 99999;" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Towards a New Digital Business Operating System</h4>
            </div>
            <div class="modal-body">
                <p>
