        ...
        <div class="row">
            <div class="col-md-12">
                <p style="text-align: justify;">
                    The Tool Demonstration track is an important part of the 25th edition of the International Conference on Software Analysis, Evolution, and Reengineering (SANER’18), with the goal of showcasing live presentation of tool prototypes. Tools and their demonstrations are central to research in software maintenance, reverse engineering and reengineering, have a prominent role in the conference, and increase substantially the visibility of the associated research.
                </p>
                <br>
                <p style="text-align: justify;">
            ...
            foreach ($json['commiteeMembers']['tool_track'] as $key => $value) {
                ...
                <div class="col-md-4">
                    <?php if (!is_null($value['website'])) { ?>
                        <a href="<?php echo $value['website'] ?>" target="_blank"><?php echo $value['name'] ?></a><?php if ($value['name'] == 'Mario Linares Vasquez' || $value['name'] == 'Luca Ponzanelli') { echo ' <span style="font-size: 18px;">(co-Chair)</span>';} ?>
                    <?php } else { ?>
